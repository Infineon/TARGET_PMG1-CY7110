...
#ifndef CYPM1011_24LQXI
    #error "Unexpected target MCU; expected CYPM1011-24LQXI. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
